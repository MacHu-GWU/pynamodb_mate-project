# -*- coding: utf-8 -*-
#
# pynamodb_mate documentation build configuration file, created by
...
version = pynamodb_mate.__version__
# The full version, including alpha/beta/rc tags.
release = pynamodb_mate.__version__
...
htmlhelp_basename = 'pynamodb_matedoc'
...
latex_documents = [
    (master_doc, 'pynamodb_mate.tex', 'pynamodb_mate Documentation',
     u'Sanhe Hu', 'manual'),
]
...
man_pages = [
    (master_doc, 'pynamodb_mate', 'pynamodb_mate Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pynamodb_mate', 'pynamodb_mate Documentation',
     author, 'pynamodb_mate', 'One line description of project.',
     'Miscellaneous'),
]
...
# Add data for Jinja2
try:
    from pynamodb_mate.docs import doc_data
except:
    doc_data = dict()
...
package_name = pynamodb_mate.__name__
